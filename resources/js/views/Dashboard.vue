              ...
              <div class="flex items-center">
                ...
                <div class="ml-5 w-0 flex-1">
                  <dl>
                    ...
                    <dd class="text-lg font-medium text-gray-900">{{ stats.customers || 0 }}</dd>
                  </dl>
                </div>
              </div>
            </div>
              ...
              <div class="flex items-center">
                ...
                <div class="ml-5 w-0 flex-1">
                  <dl>
                    ...
                    <dd class="text-lg font-medium text-gray-900">{{ stats.leads || 0 }}</dd>
                  </dl>
                </div>
              </div>
            </div>
              ...
              <div class="flex items-center">
                ...
                <div class="ml-5 w-0 flex-1">
                  <dl>
                    ...
                    <dd class="text-lg font-medium text-gray-900">{{ stats.estimates || 0 }}</dd>
                  </dl>
                </div>
              </div>
            </div>
              ...
              <div class="flex items-center">
                ...
                <div class="ml-5 w-0 flex-1">
                  <dl>
                    ...
                    <dd class="text-lg font-medium text-gray-900">{{ stats.appointments || 0 }}</dd>
                  </dl>
                </div>
              </div>
            </div>
          ...
          <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
            ...
            <div class="relative group bg-white p-6 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-500 rounded-lg shadow hover:shadow-md transition-shadow">
              ...
              <div class="mt-8">
                ...
                <p class="mt-2 text-sm text-gray-500">
                  Schedule a new appointment or site visit.
                </p>
              </div>
            </div>
          </div>
...
// Single responsibility: display dashboard data
const stats = ref({
  customers: 0,
  leads: 0,
  estimates: 0,
