          ...
          <div class="flex">
            ...
            <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
              ...
              <router-link
                to="/appointments"
                class="inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium leading-5 transition duration-150 ease-in-out"
                :class="$route.name?.startsWith('appointments') ? 'border-indigo-400 text-gray-900' : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300'"
              >
                Calendar
              </router-link>
      ...
      <div :class="{'block': mobileMenuOpen, 'hidden': !mobileMenuOpen}" class="sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
          ...
          <router-link
            to="/appointments"
            class="block pl-3 pr-4 py-2 border-l-4 text-base font-medium leading-6 transition duration-150 ease-in-out"
            :class="$route.name?.startsWith('appointments') ? 'bg-indigo-50 border-indigo-400 text-indigo-700' : 'border-transparent text-gray-600 hover:text-gray-800 hover:bg-gray-50 hover:border-gray-300'"
          >
            Calendar
          </router-link>
