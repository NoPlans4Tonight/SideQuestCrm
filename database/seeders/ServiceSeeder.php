...
class ServiceSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $services = [
              ...
              tenant_id => $tenant->id,
                nameChimney Cleaning,
                description' =>Complete chimney cleaning and inspection service,
                category' => 'Cleaning,
              base_price' => 1500            hourly_rate' =>750         is_active' => true,
               created_by' => $user->id,
            ],
              ...
              tenant_id => $tenant->id,
                ...
                category' => 'Repair,
              base_price' => 3000            hourly_rate' =>850         is_active' => true,
               created_by' => $user->id,
            ],
             ...
             category => 'Installation,
              base_price' => 2000            hourly_rate' =>650         is_active' => true,
               created_by' => $user->id,
            ],

              tenant_id => $tenant->id,
                nameChimney Inspection,
                description => ofessional chimney inspection and safety assessment,
             category => ing,
              base_price' => 1000            hourly_rate' =>600         is_active' => true,
               created_by' => $user->id,
            ],
             ...
             category => 'Installation,
              base_price' => 25000            hourly_rate' =>950         is_active' => true,
               created_by' => $user->id,
            ]
        ];
